...
\subsubsection{Implementation and Capabilities}
...
\emph{parmed.py} is ideal for scripting purposes.

\begin{figure}
   \includegraphics[width=6.5, height=5.91]{xparmed.png}
...
\subsubsection{van der Waals Modifications}
...
\subsubsection{Manipulating Atomic Order}
