...
\ref{eq1:RayleighJeans}, we clearly see that the emission spectrum diverges at
high frequencies---a clear violation of the well-established law of conservation
of energy.
\begin{equation}
   B_{\nu} (T)  = \frac{2 \nu^2 k T} {c^2}
...
same value of the property of $A$. $P(a)$ is the normalized probability for that
state, where $\sum_a W(a)$ is the normalization factor.
...
perturbation on the system is too large. To address this problem,
